...
Artifact: `target/mule-clouderby-1.16.0-mule-application.jar`
...
| Path | Method | Description |
|------|--------|-------------|
| `/` | GET | Admin UI (`src/main/resources/static/index.html`). The Tables tab has Console / DDL / **ER** sub-tabs |
