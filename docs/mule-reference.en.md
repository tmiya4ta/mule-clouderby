...
Artifact: `target/mule-clouderby-1.15.1-mule-application.jar`
...
```bash
yc deploy file <org> <env> <group> mule-clouderby 1.15.1 \
  target/mule-clouderby-1.15.1-mule-application.jar target=ps:<private-space>
```
